...
If you want to implement pre-trained language model-based FINE-LMT, please refer to [VGAMT](https://www.statmt.org/wmt17/multimodal-task.html) and replace the file "fine-lmt-plm.py" with "vgamt.py".
